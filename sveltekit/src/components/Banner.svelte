<div class="wwd tc-white bg-Rocket d-bloc" id="bloc-3">
  <div class="container bloc-lg bloc-no-padding-lg bloc-no-padding-md">
    <div class="row">
      <div class="col-lg-5 col-sm-11">
        <h2 class="mg-md h2-style tc-white-2">What we do ?</h2>
        <div class="green-line object-hidden">
          <svg
            width="200"
            height="44"
            viewBox="0 0 236 31"
      ...
      <div class="col-lg-7 col-sm-11">
        <p class="big-p float-lg-none">
          Satellit does not set out to be “yet another” IT service provider! Our
          target is to marshal experienced IT profiles to evolve as one in a
          common direction: boosting our clients' expertise through our
          top-rated employees and freelancers.
        </p>
      </div>
    </div>
  </div>
...
<style>
  ...
  .bg-Rocket {
    background-image: url("https://www.satellit.be/img/Rocket.png");
  }
  .wwd {
    margin-top: 100px;
    margin-bottom: 100px;
