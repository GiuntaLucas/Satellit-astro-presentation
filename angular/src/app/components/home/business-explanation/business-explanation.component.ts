...
@Component({
  selector: 'app-business-explanation',
  templateUrl: './business-explanation.component.html',
  styleUrls: ['./business-explanation.component.scss']
})
export class BusinessExplanationComponent {
  business = [
    {
